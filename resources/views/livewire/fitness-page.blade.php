<div class="mt-8 ml-12">
    ...
    <form class="pt-4">
        <div>
            ...
            <input type="text" name="name" id="name" class="border w-72 rounded-md block">
        </div>

        <div class="mt-4">
            <label for="email" class="block text-sm font-medium text-gray-700">Email</label>
            <input type="text" name="email" id="email" class="border w-72 rounded-md block">
        </div>

        <div class="mt-4">
            <label for="phone" class="block text-sm font-medium text-gray-700">Phone</label>
            <input type="number" name="phone" id="phone" class="border w-72 rounded-md block">
        </div>
